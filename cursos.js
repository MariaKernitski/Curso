...
const modelo = () => {
    ...
    while(true) {
        const prof = prompt("Digite o nome do professor, ou digite 'fim' para encerrar: ");
    ...
    while(true) {
        const materia = prompt("Digite o nome do aluno, ou digite 'fim' para encerrar: ");
...
const listar = () => {
    ...
    cursos.forEach((el, i) => {  //el de elemento
    console.log(`${i + 1} - 
    Nome: ${el.nome}
    Duração: ${el.duracao}
